# 0053 — A domain reduction belongs in `stat` when its output is the chart
...
- A **hierarchical clustering** is not, and [ADR 0052](0052-tidy-tree-layout.md)
...
([ADR 0049](0049-locus-annotations.md)) and needs nothing from this record.
